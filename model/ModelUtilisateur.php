...
class ModelUtilisateur extends ModelGeneric {
     ...
     * @param null $rang
     */
    public function __construct($id = null , $nom, $prenom, $password, $confirm_password = null, $email, $confirm_email = null, $dateInscription, $adresse, $nomVille, $pays, $rang = null)
    {
        $this->id = $id;
        $this->nom = $nom;
        $this->prenom = $prenom;
    ...
    {
        if (strlen($adresse) < 100 && strlen($adresse) > 0){
            $this->adresse = $adresse;
        }
    }
    ...
    {
        if (strlen($nomVille) < 30 && strlen($nomVille) > 0){
            $this->nomVille = $nomVille;
        }
    }
    ...
    {
        if (strlen($pays) < 30 && strlen($pays) > 0){
            $this->pays = $pays;
        }
    }
